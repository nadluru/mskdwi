...
scheme=${dwi%.nii*}_Camino.scheme
export dti=${dwi%.nii*}_dti.Bfloat
tracts=${dwi%.nii*}_tracts
...
track -inputmodel dt -inputfile $dti -inputdatatype float -outputdatatype float -seedfile $mask -anisthresh 0 -curvethresh 45 -curveinterval 0.5 -stepsize 0.1 -tracker euler -outputfile $tracts.Bfloat
